...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://kefasdigital.com", "https://www.kefasdigital.com"],  # FIX: dominio real
...
def enviar_notificacion_kefas(datos: Lead):
    ...
    try:
        with smtplib.SMTP_SSL("smtp.hostinger.com", 465) as servidor:  # FIX: puerto 465
